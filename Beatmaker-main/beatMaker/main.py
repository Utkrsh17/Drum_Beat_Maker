...
'''
hi_hat = mixer.Sound('beatMaker\sounds\hi hat.wav')
snare = mixer.Sound('beatMaker\sounds\snare.wav')
kick = mixer.Sound('beatMaker\sounds\kick.wav')
crash = mixer.Sound('beatMaker\sounds\crash.wav')
clap = mixer.Sound('beatMaker\sounds\clap.wav')
tom = mixer.Sound(r"beatMaker\sounds\tom.WAV")

screen = pygame.display.set_mode([WIDTH, HEIGHT])
pygame.display.set_caption('The Beat Maker')
label_font = pygame.font.Font('beatMaker\Roboto-Bold.ttf', 32)
medium_font = pygame.font.Font('beatMaker\Roboto-Bold.ttf', 24)
beat_changed = True
...
load_menu = False
saved_beats = []
file = open('beatMaker\saved_beats.txt', 'r')
for line in file:
